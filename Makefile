...
FC = gfortran
FFLAGS = -O2 -I/usr/local/include -Wall -g -fcheck=array-temps,bounds,do,mem,pointer,recursion -ffpe-trap=invalid,zero,overflow
LD = f90
...
nisl_2step_module.o : grid_module.o time_module.o legendre_transform_module.o upstream_module.o sphere_module.o field_module.o mass_module.o
...
main.o : grid_module.o time_module.o euler_module.o semilag_module.o nisl_module.o nisl_2step_module.o field_module.o analysis_module.o direction_module.o direction16_module.o
